...
#         y = batch[3].to(device)
        ...
        predictions=torch.sigmoid(model.decode(z,src_nodes,dst_nodes)).view(-1)
        recommendations[dst_node] = {'src_nodes': src_nodes, 'confidence': predictions}
torch.save(recommendations, 'research/citation_recommendation/random_recommendations_pratik2.pt')